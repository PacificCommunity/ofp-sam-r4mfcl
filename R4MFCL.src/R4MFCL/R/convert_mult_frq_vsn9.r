# this is a script that Nick Davies uses to convert from .frq vsn 8 to vsn 9 
# commented out by Nicholas Ducharme-Barth 02/05/2019 since it breaks the build of R4MFCL with its hardwired source calls
